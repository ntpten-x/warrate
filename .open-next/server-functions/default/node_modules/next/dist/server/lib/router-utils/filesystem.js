...
async function setupFsCheck(opts) {
    ...
    if (!opts.dev) {
        ...
        previewProps = {
            previewModeId: require('node:crypto').randomBytes(16).toString('hex'),
            previewModeSigningKey: require('node:crypto').randomBytes(32).toString('hex'),
            previewModeEncryptionKey: require('node:crypto').randomBytes(32).toString('hex')
        };
    }
