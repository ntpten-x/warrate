...
class Worker {
    constructor(workerPath, options){
        ...
        const createWorker = ()=>{
            var _farmOptions_forkOptions, _farmOptions_forkOptions1;
            const workerEnv = {
                ...process.env,
            ...
            this._worker = new _jestworker.Worker(workerPath, {
                ...
                forkOptions: {
                    ...
                    execArgv: [
                        ...execArgv,
                        ...((_farmOptions_forkOptions1 = farmOptions.forkOptions) == null ? void 0 : _farmOptions_forkOptions1.execArgv) || []
                    ],
                    env: workerEnv
                },
                maxRetries: 0
       ...
       */ if (!farmOptions.enableWorkerThreads) {
        ...
        const sanitizeArgs = farmOptions.enableWorkerThreads ? (args)=>JSON.parse(JSON.stringify(args)) : (args)=>args;
        for (const method of farmOptions.exposedMethods){
                ...
                try {
                    ...
                    for(;;){
                        ...
                        const result = await Promise.race([
                            this._worker[method](...sanitizedArgs),
                            restartPromise
                        ]);
            ...
            } : (...args)=>this._worker[method](...sanitizeArgs(args));
        }
    }
